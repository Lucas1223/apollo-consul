...
VALUES
    ('cosul.service.url', 'default', 'http://statefulset-apollo-config-server-prod-0.service-apollo-meta-server-prod:8080/cosul/,http://statefulset-apollo-config-server-prod-1.service-apollo-meta-server-prod:8080/cosul/,http://statefulset-apollo-config-server-prod-2.service-apollo-meta-server-prod:8080/cosul/', 'Eureka服务Url，多个service以英文逗号分隔'),
